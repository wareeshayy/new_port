            ...
            <div className="hidden md:flex space-x-8">
              {['home', 'about', 'projects', 'skills', 'contact'].map((item) => (
                <button
                  ...
                  className={`capitalize transition-colors duration-300 hover:text-blue-400 ${activeSection === item ? 'text-blue-400' : 'text-gray-300'
                    }`}
                >
                  {item}
                </button>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      <a
                        href={`https://github.com/wareeshayy/${project.title}`}
                        target="_blank"
